...
def Model42(Veg_Carbon_Final, Soil_Carbon_Final, PreEventC_ElevM, PreEventC_SStrOrd, PreEventC_HStrOrd, PreEventSubcatchmentChannel, PreEventSubcatchHillslope, LitterCarbonFinal, RootCarbonFinal, Watershed_RioHondo_shp, output_directory, output_directory_raster):  # 5 Pre-event Combined Carbon stocks_rev
